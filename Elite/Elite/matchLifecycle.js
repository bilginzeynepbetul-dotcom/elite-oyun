...
async function startFixtureMatch(opts) {
  ...
  // Milli takıma çağrılıp ilk 11'e yazılan oyuncular o hafta kulüp
  // maçında saha dışı kalır (matchEngine 11'in altını otomatik
  // mock oyuncuyla tamamlar — bkz. matchEngine.js team.players.length < 11).
  try {
    ...
    console.warn("[matchLifecycle] milli görev filtresi", e.message);
  }
