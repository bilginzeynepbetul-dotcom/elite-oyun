-- ============================================================
-- Migration 028: Milli takım şema tamamlama (idempotent)
-- 007 / 009 / 011 eksik kaldıysa national/state 500 önler
-- ============================================================
...
ALTER TABLE national_teams
  ADD COLUMN IF NOT EXISTS pass_style VARCHAR(16) NOT NULL DEFAULT 'kisa';

ALTER TABLE national_squad
